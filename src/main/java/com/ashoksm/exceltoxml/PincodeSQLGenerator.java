...
public class PincodeSQLGenerator {
    ...
    private static final String SQL =
            "INSERT INTO post_office_t VALUES('<OfficeName>', <Pincode>, <District>, <State>, <Status>, '<SubOffice>', '<HeadOffice>', <Location>, '<Telephone>');";
                ...
                if (!"Null".equalsIgnoreCase(officeModel.getStateName())) {
                    ...
                    try {
                        line = SQL
                                ...
                                .replaceAll(
                                        "<Location>",
                                        LOCATION_MAP.get(officeModel.getTaluk().replaceAll("\\*", "")
                                                .replaceAll("\\\\+", "").trim()
                                                .toLowerCase()))
                                .replaceAll(
                                        "<Telephone>",
                                ...
                                .replaceAll("<District>",
                                        DISTRICT_MAP.get(formatString(officeModel.getDistrictName())));
                    } catch (Exception ex) {
                        ex.printStackTrace();
